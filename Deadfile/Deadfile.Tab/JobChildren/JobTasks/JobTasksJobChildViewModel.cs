...
namespace Deadfile.Tab.JobChildren.JobTasks
{
    ...
    class JobTasksJobChildViewModel : SimpleEditableItemViewModel<JobTaskModel>, IJobTasksJobChildViewModel
    {
        ...
        public JobTasksJobChildViewModel(IDeadfileDispatcherTimerService timerService, IDeadfileRepository repository, IEventAggregator eventAggregator) : base(timerService, eventAggregator)
        {
